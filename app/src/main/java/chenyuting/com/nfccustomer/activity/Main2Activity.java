...
//                break;
            case 0: //写NFC标签非NDEF格式的数据
                startActivity(new Intent(this, WriteCouponActivity.class));
                break;
            case 1: //写NFC标签非NDEF格式的数据
                startActivity(new Intent(this, ReadCouponActivity.class));
                break;
            default:
                break;
        }
